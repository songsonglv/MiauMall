...
- (void)viewDidLoad {
    ...
    if([ID isEqualToString:@"1078"] || [ID isEqualToString:@"1079"]){
        [self GetStoreInfo];
    }else{
        [self GetStoreInfo1];
    }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if(section == 1){
        ...
        UIImageView *bgImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, WIDTH, 40)];
        bgImage.userInteractionEnabled = YES;
        ...
        UILabel *limitLa = [UILabel publicLab:@"正在秒杀" textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:13 numberOfLines:0];
        ...
        limitLa.frame = CGRectMake(5, 16, size.width, 13);
        [bgImage addSubview:limitLa];
        ...
        CGSize size1 = [NSString sizeWithText:str2 font:[UIFont fontWithName:@"PingFangSC-Medium" size:18] maxSize:CGSizeMake(MAXFLOAT,18)];
        UILabel *tomoLa = [UILabel publicLab:str2 textColor:TCUIColorFromRGB(0x211325) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:18 numberOfLines:0];
        tomoLa.frame = CGRectMake(WIDTH/2 + (WIDTH/2 - size1.width)/2, 15, size1.width, 18);
        [bgImage addSubview:tomoLa];
        self.tomoLa = tomoLa;
        ...
        if([self.isTomorro isEqualToString:@"0"]){
            bgImage.image = [UIImage imageNamed:@"tomo_normal"];
            ...
            bgImage.image = [UIImage imageNamed:@"tomo_select"];
