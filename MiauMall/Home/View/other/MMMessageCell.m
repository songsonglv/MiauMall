...
-(void)creatUI{
    ...
    UILabel *detailLa = [UILabel publicLab:@"查看明细" textColor:TCUIColorFromRGB(0xa0a0a0) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:14 numberOfLines:0];
