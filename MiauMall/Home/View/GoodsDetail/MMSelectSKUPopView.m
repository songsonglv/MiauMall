...
-(void)creatUI{
    ...
    UILabel *selectLa = [UILabel publicLab:@"已选：" textColor:TCUIColorFromRGB(0x8a8a8a) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
    selectLa.preferredMaxLayoutWidth = 50;
    ...
    UILabel *numLa = [UILabel publicLab:@"x1件" textColor:TCUIColorFromRGB(0x8a8a8a) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
    ...
    UILabel *zhongLa = [UILabel publicLab:@"重量：" textColor:TCUIColorFromRGB(0x8a8a8a) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
    zhongLa.preferredMaxLayoutWidth = 50;
    ...
    UILabel *lab = [UILabel publicLab:@"数量:" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-SemiBold" size:14 numberOfLines:0];
    lab.frame = CGRectMake(12, 332, 40, 14);
    [self.contentView addSubview:lab];
    
    
    UILabel *stockLa = [UILabel publicLab:@"库存充足" textColor:TCUIColorFromRGB(0x333333) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:13 numberOfLines:0];
    ...
    if([self.model.attbuying.number integerValue] < 5){
        stockLa.text = [NSString stringWithFormat:@"库存不足(剩余%ld)",[self.model.attbuying.number integerValue]];
...
-(void)changeInfo{
    ...
    for (MMGoodsAttdataModel *model in arr) {
        if([model.classarr isEqualToString:seleStr]){
            ...
            if(num < 5){
                self.stockLa.text = [NSString stringWithFormat:@"库存不足(剩余%ld)",num];
            }else{
                self.stockLa.text = @"库存充足";
            }
...
-(void)clickSub{
    ...
    self.numLa.text = [NSString stringWithFormat:@"x%ld件",(long)num];
...
-(void)clickAdd{
    ...
    if(num < maxNum){
        ...
        [ZTProgressHUD showMessage:[NSString stringWithFormat:@"单ID限购%ld件",(long)maxNum]];
    }
    self.numFeild.text = [NSString stringWithFormat:@"%ld",(long)num];
    self.numLa.text = [NSString stringWithFormat:@"x%ld件",(long)num];
    self.numStr = [NSString stringWithFormat:@"%ld",(long)num];
