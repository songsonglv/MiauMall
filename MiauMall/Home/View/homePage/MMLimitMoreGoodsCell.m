...
-(void)creatUI{
    ...
    UILabel *speedLa = [UILabel publicLab:@"48h发货" textColor:redColor2 textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-SemiBold" size:11 numberOfLines:0];
    ...
    UILabel *goLa = [UILabel publicLab:@"立即抢购" textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:13 numberOfLines:0];
...
-(void)setModel:(MMHomeLimitGoodsModel *)model{
    ...
    NSMutableAttributedString *newPrice = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@%@",_model.pricesign,_model.oldprice]];
