...
- (CGPathRef )bubblePath {
    ...
    while(count < 7) {
        ...
        radius = count < 0 ?  _arrowRadius : _cornerRadius;
...
- (CAShapeLayer *) layer{
    ...
    layer.shadowColor = [UIColor colorWithRed:180/255.0 green:180/255.0 blue:180/255.0 alpha:0.15].CGColor;
    layer.shadowOffset = CGSizeMake(0,5);
    layer.shadowOpacity = 1;
    layer.shadowRadius = 5;
//    layer.borderWidth = 2;
//    layer.borderColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:244/255.0 alpha:1.0].CGColor;
    
    layer.strokeColor = redColor3.CGColor;
