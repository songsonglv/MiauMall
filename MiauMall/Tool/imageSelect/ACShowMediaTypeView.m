...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        layout.minimumInteritemSpacing = 78;
        layout.minimumLineSpacing = 78;
        layout.sectionInset = UIEdgeInsetsMake(15, 78, 22, 78);
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, ACMedia_ScreenHeight, ACMedia_ScreenWidth, itemW + 78/2 * 2) collectionViewLayout:layout];
...
//        self.itemArray = @[@"camera", @"work_photo"];
    }
    return self;
}
