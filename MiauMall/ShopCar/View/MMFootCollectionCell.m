...
-(void)setupUI{
    ...
    UILabel *titleLa = [UILabel publicLab:@"浏览记录" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    ...
    UILabel *moreLa = [UILabel publicLab:@"更多" textColor:TCUIColorFromRGB(0x807f7f) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:12 numberOfLines:0];
