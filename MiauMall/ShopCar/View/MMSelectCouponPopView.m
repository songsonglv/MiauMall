...
-(void)creatUI{
    ...
    UILabel *titleLa = [UILabel publicLab:@"优惠券" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-SemiBold" size:16 numberOfLines:0];
    ...
    UILabel *lab = [UILabel publicLab:@"不使用优惠券" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:14 numberOfLines:0];
    ...
    UILabel *tipLa = [UILabel publicLab:@"注：优惠券与折扣码不能同时使用" textColor:TCUIColorFromRGB(0xa5844d) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
...
-(void)setArr:(NSArray *)arr{
    _arr = arr;
    self.numLa.text = [NSString stringWithFormat:@"可使用优惠券(%ld)",_arr.count];
