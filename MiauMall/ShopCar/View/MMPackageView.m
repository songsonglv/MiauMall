...
-(void)creatUI{
    ...
    UILabel *addressLa = [UILabel publicLab:@"请选择收货地址" textColor:TCUIColorFromRGB(0x1e1e1e) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:12 numberOfLines:0];
    ...
    UILabel *lab1 = [UILabel publicLab:@"配送" textColor:TCUIColorFromRGB(0x1e1e1e) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:14 numberOfLines:0];
    ...
    UILabel *weightLa = [UILabel publicLab:@"共1.45kg" textColor:TCUIColorFromRGB(0xa5844d) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
    ...
    UILabel *lab2 = [UILabel publicLab:@"备注" textColor:TCUIColorFromRGB(0x1e1e1e) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:14 numberOfLines:0];
    lab2.preferredMaxLayoutWidth = 80;
    ...
    field1.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"选填，请先与客服沟通确认协商一致" attributes:@{NSForegroundColorAttributeName:TCUIColorFromRGB(0x999999)}];
...
-(void)setGoodsView{
        ...
        UILabel *lab = [UILabel publicLab:[NSString stringWithFormat:@"共%@件",number] textColor:TCUIColorFromRGB(0x8f8f8f) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:13 numberOfLines:0];
