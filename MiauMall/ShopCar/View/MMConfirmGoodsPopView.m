...
-(void)creatUI{
    ...
    UILabel *titleLa = [UILabel publicLab:@"商品清单" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
...
-(void)setModel:(MMConfirmOrderModel *)model{
    ...
    self.numLa.text = [NSString stringWithFormat:@"共%@件",num];
    NSArray *arr;
    if(self.index == 0){
