...
-(void)creatUI{
    ...
    UIImageView *rankImage = [[UIImageView alloc]initWithFrame:CGRectMake(83, 5, 34, 30)];
    [conV addSubview:rankImage];
...
-(void)setIndex:(NSInteger)index{
    _index =  index;
    NSString *name = [NSString stringWithFormat:@"rank%ld_icon",_index];
    self.rankImage.image = [UIImage imageNamed:name];
}
