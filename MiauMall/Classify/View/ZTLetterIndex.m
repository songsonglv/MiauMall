...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.textColor = TCUIColorFromRGB(0x333333);
        self.selectedTextColor = TCUIColorFromRGB(0x333333);
        self.itemSize = CGSizeMake(12.0f, 16.0f);
        self.sliderSize = CGSizeMake(12.0f, 40.0f);
        self.sliderColor = [UIColor clearColor];
        self.textFont = [UIFont fontWithName:@"PingFangSC-Regular" size:12.0f];
        self.layer.masksToBounds = YES;
        self.layer.cornerRadius = 10;
        self.layer.borderColor = TCUIColorFromRGB(0xa0a0a0).CGColor;
        self.layer.borderWidth = 0.5;
        self.layer.shadowColor = TCUIColorFromRGB(0x000000).CGColor;
...
- (void)setupItems
{
    ...
    [self.dataArray enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        item.frame = CGRectMake((self.bounds.size.width - self.itemSize.width)/2, self.itemSize.height * idx + (_slidr.bounds.size.height - self.itemSize.height) - 20, self.itemSize.width, self.itemSize.height);
...
//    firstItem.frame = CGRectMake((self.bounds.size.width - self.sliderSize.width)/2, 0, self.itemSize.width, _slidr.bounds.size.height);
