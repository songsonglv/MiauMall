...
-(UIView *)bottomV{
    if(!_bottomV){
        ...
        UILabel *showLa = [UILabel publicLab:@"展开阅读全文" textColor:TCUIColorFromRGB(0x888888) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
...
-(void)creatUI{
    ...
    UILabel *numLa = [UILabel publicLab:[NSString stringWithFormat:@"%@件商品在售",self.model.BrandNum] textColor:TCUIColorFromRGB(0x888888) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
...
-(void)clickShow:(UIButton *)sender{
    ...
    if(self.showBt.selected == YES){
        self.showLa.text = @"收起";
        CGSize size = [NSString sizeWithText:@"收起" font:[UIFont fontWithName:@"PingFangSC-Regular" size:12] maxSize:CGSizeMake(MAXFLOAT,12)];
        ...
        CGSize size = [NSString sizeWithText:@"展开阅读全文" font:[UIFont fontWithName:@"PingFangSC-Regular" size:12] maxSize:CGSizeMake(MAXFLOAT,12)];
        self.showLa.text = @"展开阅读全文";
        self.showLa.frame = CGRectMake((WIDTH - (size.width + 12))/2, 17, size.width, 12);
