...
-(void)setAssesslevel5rate:(NSString *)assesslevel5rate{
    ...
    self.goodLabel.text = [NSString stringWithFormat:@"%@%@",[UserDefaultLocationDic valueForKey:@"praiseRate"],_assesslevel5rate];
}

-(void)setTags:(NSArray *)tags{
    _tags = tags;
    NSDictionary *dic = @{@"Name":[UserDefaultLocationDic valueForKey:@"iall"],@"Count":@"",@"ID":@"0"};
    NSDictionary *dic2 = @{@"Name":[UserDefaultLocationDic valueForKey:@"jxComment"],@"Count":@"",@"ID":@"0"};
