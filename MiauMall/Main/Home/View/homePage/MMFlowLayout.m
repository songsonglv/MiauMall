...
@implementation MMFlowLayout

- (void)prepareLayout {
    [super prepareLayout];
    
    NSAssert(self.dataSource != nil, @"MMFlowLayout.dataSource cann't be nil.");
    ...
    for (NSInteger section=0; section < numberOfSections; section++) {
        ...
        NSAssert(columnOfSection > 0, @"[MMFlowLayout collectionView:layout:numberOfColumnInSection:] must be greater than 0.");
