...
#import "MMLimitTypeCell.h"  //限时抢购1
#import "MMLimitEightCell.h" //限时抢购8
...
-(void)setModel:(MMHomePageModel *)model{
    ...
    [self.twoimg2Arr removeAllObjects];
    [self.twoimg1Arr removeAllObjects];
    [self.stackBannerArr removeAllObjects];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    }else if ([model.type isEqualToString:@"limit8"]){
        return 268;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([model.type isEqualToString:@"banner"]){
        ...
        MMLimitEightCell *cell = [[MMLimitEightCell alloc]initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:@"limit8"];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        cell.model = model;
        cell.TapLimitEightMoreBlock = ^(NSString * _Nonnull str) {
            weakself.limit8TapMoreBlock(str);
        };
        return cell;
    }else if ([model.type isEqualToString:@"reclist8"]){
