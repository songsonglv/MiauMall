...
#import "MMProList4Cell.h"

@interface MMProList4Cell ()
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) NSMutableArray *goodsArr;
@end

@implementation MMProList4Cell
...
-(void)setModel:(MMHomePageItemModel *)model{
    ...
    for (int i = 0; i < arr.count; i++) {
        ...
        UILabel *priceLa = [UILabel publicLab:model1.priceshow textColor:redColor2 textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Semibold" size:16 numberOfLines:0];
        priceLa.preferredMaxLayoutWidth = WIDTH - 215;
        ...
        UILabel *payLa = [UILabel publicLab:@"购买" textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:14 numberOfLines:0];
        payLa.backgroundColor = redColor2;
...
-(void)clickGoods:(id)sender{
    ...
    self.TapPro4GoodsBlock(model.link2);
}
@end
