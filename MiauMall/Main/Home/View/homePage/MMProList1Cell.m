...
-(void)setModel:(MMHomePageItemModel *)model{
    ...
    for (int i = 0; i < arr.count; i++) {
        ...
        if(realnum > 0){
            CGSize size1 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"ship48h"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:11] maxSize:CGSizeMake(MAXFLOAT,11)];
            ...
            CGSize size5 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"ishansong"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:11] maxSize:CGSizeMake(MAXFLOAT,11)];
            UILabel *shanLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ishansong"] textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:11 numberOfLines:0];
            shanLa.frame = CGRectMake(10, 2, size5.width, 11);
            [labV addSubview:shanLa];
            
            UILabel *liLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ship48h"] textColor:redColor2 textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:11 numberOfLines:0];
            ...
            CGSize size5 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"iyuding"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:11] maxSize:CGSizeMake(MAXFLOAT,11)];
            
            CGSize size6 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"sdqfh"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:11] maxSize:CGSizeMake(MAXFLOAT,11)];
            ...
            [labV mas_makeConstraints:^(MASConstraintMaker *make) {
                            make.left.mas_equalTo(7);
                            make.top.mas_equalTo(nameLa.mas_bottom).offset(10);
                            make.width.mas_equalTo(size5.width + size6.width + 8);
                            make.height.mas_equalTo(15);
            }];
            
            UIView *greenV = [[UIView alloc]initWithFrame:CGRectMake(0, 0, size5.width + 4, 15)];
            ...
            UILabel *shanLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"iyuding"] textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:11 numberOfLines:0];
            
            shanLa.frame = CGRectMake(2, 2, size5.width, 11);
            [labV addSubview:shanLa];
            
            UILabel *liLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"sdqfh"] textColor:greenColor1 textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:11 numberOfLines:0];
            
            liLa.frame = CGRectMake(CGRectGetMaxX(shanLa.frame) + 2, 2, size6.width, 11);
            [labV addSubview:liLa];
        }
