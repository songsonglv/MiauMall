//
//  MMSecondPageNavCell.m
//  MiauMall
//
//  Created by 吕松松 on 2023/2/28.
//  二级页面导航链接cell

#import "MMSecondPageNavCell.h"

@interface MMSecondPageNavCell ()
...
@implementation MMSecondPageNavCell
...
-(UIScrollView *)mainScrollView{
    if(!_mainScrollView){
        _mainScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, WIDTH, self.height)];
