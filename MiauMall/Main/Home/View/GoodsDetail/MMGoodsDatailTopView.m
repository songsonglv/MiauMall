...
-(void)setUI{
    ...
    UILabel *lab = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"isearch"] textColor:TCUIColorFromRGB(0x727272) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:13 numberOfLines:0];
    ...
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"iproducts"],[UserDefaultLocationDic valueForKey:@"recommendgood"],[UserDefaultLocationDic valueForKey:@"idetails"],[UserDefaultLocationDic valueForKey:@"recommendgood"]];
    CGFloat wid = WIDTH/4;
