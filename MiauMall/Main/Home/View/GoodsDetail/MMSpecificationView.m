...
-(void)setUI{
    ...
    UILabel *lab = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ispecifications"] textColor:TCUIColorFromRGB(0x373737) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:12 numberOfLines:0];
    [self addSubview:lab];
