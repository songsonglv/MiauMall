...
-(void)creatUI{
    ...
    [self.contentV addGestureRecognizer:tap1];
    
    
    UILabel *lab = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ishare"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:15 numberOfLines:0];
    lab.frame = CGRectMake(0, 6, WIDTH, 15);
    [self.contentV addSubview:lab];
    
    //@[@"微信好友",@"朋友圈",@"新浪微博",@"下载海报"];
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"downPoster"]];
    NSArray *imgArr = @[@"down_poster_icon"];
