...
-(UILabel *)assessCountLa{
    if(!_assessCountLa){
        _assessCountLa = [UILabel publicLab:[NSString stringWithFormat:@"%@(0)",[UserDefaultLocationDic valueForKey:@"proComment"]] textColor:TCUIColorFromRGB(0x373737) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-SemiBold" size:15 numberOfLines:0];
...
-(UILabel *)receiveLa{
    if(!_receiveLa){
        _receiveLa = [UILabel publicLab:[NSString stringWithFormat:@"%@0%",[UserDefaultLocationDic valueForKey:@"praiseRate"]] textColor:TCUIColorFromRGB(0x373737) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
...
-(UILabel *)noneLa{
    if(!_noneLa){
        _noneLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"lxzuji"] textColor:TCUIColorFromRGB(0x373737) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
    }
    return _noneLa;
}
...
-(void)setProInfoModel:(MMGoodsProInfoModel *)proInfoModel{
    ...
    self.assessCountLa.text = [NSString stringWithFormat:@"%@(%@)",[UserDefaultLocationDic valueForKey:@"proComment"],_proInfoModel.assesscount];
    self.receiveLa.text = [NSString stringWithFormat:@"%@%@",[UserDefaultLocationDic valueForKey:@"praiseRate"],_proInfoModel.assesslevel5rate];
    NSString *lang = [[NSUserDefaults standardUserDefaults] valueForKey:@"language"];
    if([lang isEqualToString:@"1"]){
        self.receiveLa.hidden = YES;
    }
