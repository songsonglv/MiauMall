...
-(void)creatUI{
    ...
    UILabel *tiLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ishare"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Mdeium" size:15 numberOfLines:0];
    ...
    //@[@"微信好友",@"朋友圈",@"新浪微博",@"生成海报",@"投诉",@"我的足迹"];
    
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"wxFriend"],[UserDefaultLocationDic valueForKey:@"createPoster"]];
    NSArray *imgArr = @[@"wx_share_icon",@"poster_icon"];
    CGFloat wid = WIDTH/3;
