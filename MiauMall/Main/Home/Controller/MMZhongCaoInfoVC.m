...
-(void)setUI{
    ...
    if(self.beforeArr.count > 0){
        ...
        NSString *str = [UserDefaultLocationDic valueForKey:@"preArticles"];
        CGSize size = [NSString sizeWithText:str font:[UIFont fontWithName:@"PingFangSC-Medium" size:14] maxSize:CGSizeMake(MAXFLOAT,14)];
        ...
        [agoBt setTitle:str forState:(UIControlStateNormal)];
...
//        [agoBt addTarget:self action:@selector(clickAgo:) forControlEvents:(UIControlEventTouchUpInside)];
        ...
        NSString *str1 = [UserDefaultLocationDic valueForKey:@"imore"];
        CGSize size1 = [NSString sizeWithText:str1 font:[UIFont fontWithName:@"PingFangSC-Medium" size:14] maxSize:CGSizeMake(MAXFLOAT,14)];
        ...
        [moreBt setTitle:str1 forState:(UIControlStateNormal)];
