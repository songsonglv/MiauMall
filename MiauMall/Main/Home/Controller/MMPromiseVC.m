...
-(void)setUI{
    KweakSelf(self);
    CGSize size = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"readed"] font:[UIFont fontWithName:@"PingFangSC-Regular" size:12] maxSize:CGSizeMake(MAXFLOAT,12)];
    ...
    [readBt setTitle:[UserDefaultLocationDic valueForKey:@"readed"] forState:(UIControlStateNormal)];
...
-(void)clickRead{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:[UserDefaultLocationDic valueForKey:@"itips"]
                                                                   message:[UserDefaultLocationDic valueForKey:@"confirmRead"]
