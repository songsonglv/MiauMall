...
-(UITableView *)mainTableView{
    if (!_mainTableView) {
        ...
        if([self.lang isEqualToString:@"1"]){
            _mainTableView.frame = CGRectMake(0, StatusBarHeight + 200, WIDTH, HEIGHT - StatusBarHeight - 200);
        }
...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"proComment"];
...
-(void)setUI{
    ...
    self.topView.height = self.topView.hei;
