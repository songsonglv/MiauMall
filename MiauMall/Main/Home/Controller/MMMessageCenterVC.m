...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"messageCenter"];
    [titleView.returnBt addTarget:self action:@selector(clickReturn) forControlEvents:(UIControlEventTouchUpInside)];
    titleView.line.hidden = YES;
    [self.view addSubview:titleView];
    
    UIButton *btn = [[UIButton alloc]init];
    [btn setTitle:[UserDefaultLocationDic valueForKey:@"signAll"] forState:(UIControlStateNormal)];
    ...
    CGSize size = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"signAll"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:14] maxSize:CGSizeMake(MAXFLOAT,14)];
