...
-(UICollectionView *)mainCollectionView{
    ...
    layout.headerReferenceSize = CGSizeMake(WIDTH,520);
...
-(UIView *)hotView1{
    ...
    if(!_hotView1){
        ...
        UILabel *titleLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"popSearch"] textColor:TCUIColorFromRGB(0x202020) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:14 numberOfLines:0];
        ...
        for (int i = 0; i < arr.count; i++) {
            ...
            NSString *text = arr[i];
            CGSize size = [NSString sizeWithText:text font:[UIFont fontWithName:@"PingFangSC-Regular" size:13] maxSize:CGSizeMake(MAXFLOAT,13)];
            
            CGFloat width = size.width + 28;
...
- (void)viewDidLoad {
    ...
    [searchBt setTitle:[UserDefaultLocationDic valueForKey:@"isearch"] forState:(UIControlStateNormal)];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if(kind == UICollectionElementKindSectionHeader){
        ...
        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, WIDTH, 480)];
        view.backgroundColor = TCUIColorFromRGB(0xffffff);
        [headV addSubview:view];
        
        [view addSubview:self.hotView1];
        UIImageView *iconImg = [[UIImageView alloc]initWithFrame:CGRectMake((WIDTH - 78)/2, CGRectGetMaxY(self.hotView.frame) + 15, 78, 86)];
        iconImg.image = [UIImage imageNamed:@"no_goods_icon"];
        [view addSubview:iconImg];
        
        UILabel *lab1 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"notFound"] textColor:TCUIColorFromRGB(0x818181) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:14 numberOfLines:0];
        lab1.frame = CGRectMake(0, CGRectGetMaxY(iconImg.frame) + 16, WIDTH, 14);
        [view addSubview:lab1];
        
        NSString *title = [UserDefaultLocationDic valueForKey:@"scspxx"];
        ...
        UILabel *lab = [UILabel publicLab:[NSString stringWithFormat:@"- %@ -",[UserDefaultLocationDic valueForKey:@"mayLike"]] textColor:TCUIColorFromRGB(0x202020) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:15 numberOfLines:0];
        lab.frame = CGRectMake(0, CGRectGetMaxY(view.frame) + 20, WIDTH, 15);
