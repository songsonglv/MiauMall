...
@property (nonatomic, copy) NSString *Processing;//3 已退款 5 已取消
@property (nonatomic, copy) NSString *IsReplace;//是否为换货 暂时不用
@property (nonatomic, copy) NSString *IsCanReturn; //能否选择
@end
