...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"ipurse"];
    [titleView.returnBt addTarget:self action:@selector(clickReturn) forControlEvents:(UIControlEventTouchUpInside)];
    [self.view addSubview:titleView];
    
    CGSize size1 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"iset"] font:[UIFont fontWithName:@"PingFangSC-Regular" size:18] maxSize:CGSizeMake(MAXFLOAT,18)];
    
    UIButton *setUpBt = [[UIButton alloc]init];
    [setUpBt setTitle:[UserDefaultLocationDic valueForKey:@"iset"] forState:(UIControlStateNormal)];
...
-(void)setUI{
    ...
    CGSize size1 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"limitedRechargeDiscount"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:17] maxSize:CGSizeMake(WIDTH - 52,MAXFLOAT)];
    
    UIView *topV = [[UIView alloc]initWithFrame:CGRectMake(10, StatusBarHeight + 52, WIDTH - 20, 422 + size1.height)];
    [self.view addSubview:topV];
    ...
    UILabel *titleLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"currentBalance"] textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:18 numberOfLines:0];
    ...
    CGSize size = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"detailedRules"] font:[UIFont fontWithName:@"PingFangSC-Regular" size:12] maxSize:CGSizeMake(MAXFLOAT,12)];
    
    UIButton *detailBt = [[UIButton alloc]init];
    [detailBt setImage:[UIImage imageNamed:@"right_while"] forState:(UIControlStateNormal)];
    [detailBt setTitle:[UserDefaultLocationDic valueForKey:@"detailedRules"] forState:(UIControlStateNormal)];
    ...
    UILabel *lab2 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"limitedRechargeDiscount"] textColor:TCUIColorFromRGB(0xfa5b34) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:17 numberOfLines:0];
    lab2.frame = CGRectMake(16, CGRectGetMaxY(topImage.frame) + 18, WIDTH - 52, size1.height);
    ...
    [otherBt setTitle:[UserDefaultLocationDic valueForKey:@"otherAmounts"] forState:(UIControlStateNormal)];
    ...
    UIView *headView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(lab2.frame) + 158, WIDTH - 20, 47)];
    headView.backgroundColor = TCUIColorFromRGB(0xfbfbfb);
    [topV addSubview:headView];
    
    UILabel *lab = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"balanceDetail"] textColor:TCUIColorFromRGB(0x2a2b2a) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:17 numberOfLines:0];
    lab.frame = CGRectMake(8, 16, 220, 17);
    ...
    [btn setTitle:[UserDefaultLocationDic valueForKey:@"iall"] forState:(UIControlStateNormal)];
