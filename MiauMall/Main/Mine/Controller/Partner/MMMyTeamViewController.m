...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"myTeam"];
...
-(void)setUI{
    ...
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"iall"],[UserDefaultLocationDic valueForKey:@"heHuoRen"],[UserDefaultLocationDic valueForKey:@"userVip"]];
...
-(void)updatePartner:(NSString *)ID{
    KweakSelf(self);
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:[UserDefaultLocationDic valueForKey:@"sjHeHuoRen"]
                                                                   message:[UserDefaultLocationDic valueForKey:@"iTips3"]
