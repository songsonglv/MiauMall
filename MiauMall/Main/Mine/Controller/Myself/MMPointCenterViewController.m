...
@property (nonatomic, strong) NSString *MoneySign;
...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"integralCenter"];
...
-(void)GetIntePageList{
    ...
    [ZTNetworking FormPostRequestUrl:url RequestPatams:param ssuccess:^(NSString *jsonStr, NSDictionary *jsonDic) {
        ...
        NSString *code = [NSString stringWithFormat:@"%@",jsonDic[@"code"]];
        if([code isEqualToString:@"1"]){
            weakself.MoneySign = [NSString stringWithFormat:@"%@",jsonDic[@"MoneySign"]];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if(kind == UICollectionElementKindSectionHeader){
        ...
        UILabel *codeLa = [UILabel publicLab:[NSString stringWithFormat:@"ID:%@",self.memberInfo.ID] textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
        ...
        UIView *todayView = [[UIView alloc]initWithFrame:CGRectMake(WIDTH - size.width - 55, 30, size.width + 45, 28)];
        ...
        UILabel *todayLa = [UILabel publicLab:str textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:12 numberOfLines:0];
...
//        [todayLa setContentHuggingPriority:(UILayoutPriorityRequired) forAxis:(UILayoutConstraintAxisHorizontal)];
        ...
        UILabel *lab = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"midou"] textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:16 numberOfLines:0];
        ...
        UILabel *lab1 = [UILabel publicLab:self.MoneySign textColor:TCUIColorFromRGB(0xffffff) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
        lab1.frame = CGRectMake(25, 137, WIDTH - 70, 12);
        [topImage addSubview:lab1];
        
        CGSize size02 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"integralRule"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:16] maxSize:CGSizeMake(MAXFLOAT,16)];
        UIButton *ruleBt = [[UIButton alloc]init];
        [ruleBt setImage:[UIImage imageNamed:@"right_while"] forState:(UIControlStateNormal)];
        [ruleBt setTitle:[UserDefaultLocationDic valueForKey:@"integralRule"] forState:(UIControlStateNormal)];
        ...
        [ruleBt mas_makeConstraints:^(MASConstraintMaker *make) {
                    ...
                    make.width.mas_equalTo(size02.width + 8);
        ...
        CGSize size01 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"integralDetails"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:16] maxSize:CGSizeMake(MAXFLOAT,16)];
        
        UILabel *detailLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"integralDetails"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
        detailLa.frame = CGRectMake(21, 30, size01.width, 16);
        ...
        UILabel *detailLa1 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"redeemNow"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
