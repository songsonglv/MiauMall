...
@property (nonatomic, assign) CGFloat hei1;
...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"shaidan"];
...
-(void)setUI{
    ...
    UILabel *lab1 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"addPic"] textColor:TCUIColorFromRGB(0x585454) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    lab1.frame = CGRectMake(6, 16, 70, 16);
    [conV addSubview:lab1];
    
    UILabel *tipsLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"maxSixPic"] textColor:TCUIColorFromRGB(0xc5c5c5) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
    tipsLa.frame = CGRectMake(6, CGRectGetMaxY(lab1.frame) + 8, WIDTH - 32, 12);
    ...
    [mediaView observeViewHeight:^(CGFloat mediaHeight) {
        ...
        conV.height = mediaHeight + 280 + weakself.hei1;
    ...
    CGSize size = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"selectThisShowOrder"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:16] maxSize:CGSizeMake(170,MAXFLOAT)];
    self.hei1 = size.height;
    
    UILabel *lab2 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"selectThisShowOrder"] textColor:TCUIColorFromRGB(0x585454) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    lab2.frame = CGRectMake(36, CGRectGetMaxY(line.frame) + 30, 170 , size.height);
    [bottomV addSubview:lab2];
    CGSize size1 = [NSString sizeWithText:[UserDefaultLocationDic valueForKey:@"pleaseSelectOrder"] font:[UIFont fontWithName:@"PingFangSC-Medium" size:10] maxSize:CGSizeMake(90,MAXFLOAT)];
    UILabel *lab3 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"pleaseSelectOrder"] textColor:TCUIColorFromRGB(0x585454) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:10 numberOfLines:0];
    lab3.frame = CGRectMake(conV.width - 112, CGRectGetMaxY(line.frame) + 36, 90, size1.height);
    ...
    UILabel *lab4 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"only30daysOrder"] textColor:TCUIColorFromRGB(0xbcbcbc) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:12 numberOfLines:0];
    lab4.frame = CGRectMake(16, CGRectGetMaxY(lab2.frame) + 12, WIDTH - 52, 12);
    [bottomV addSubview:lab4];
    
    UILabel *lab5 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"selectCorresponding"] textColor:TCUIColorFromRGB(0x585454) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    lab5.frame = CGRectMake(16, CGRectGetMaxY(lab4.frame) + 26, WIDTH - 52, 16);
    ...
    bottomV.height = CGRectGetMaxY(field.frame) + 20;
    conV.height = CGRectGetMaxY(bottomV.frame) + 10;
    ...
    [agreeLa rz_colorfulConfer:^(RZColorfulConferrer * _Nonnull confer) {
        confer.text([UserDefaultLocationDic valueForKey:@"iHaveAgreed"]).font([UIFont fontWithName:@"PingFangSC-Regula" size:11]).textColor(TCUIColorFromRGB(0x585454));
        confer.text([NSString stringWithFormat:@"《%@》",[UserDefaultLocationDic valueForKey:@"MiauMallShowOrderGift"]]).font([UIFont fontWithName:@"PingFangSC-Regular" size:11]).textColor(TCUIColorFromRGB(0xe44822)).tapActionByLable(@"1");
    }];
    ...
    [saveBt setTitle:[UserDefaultLocationDic valueForKey:@"submitAudit"] forState:(UIControlStateNormal)];
...
-(void)seleOrder{
    if(self.orderArr.count > 0){
        ...
        [ZTProgressHUD showMessage:[UserDefaultLocationDic valueForKey:@"noOrders"]];
    }
}
