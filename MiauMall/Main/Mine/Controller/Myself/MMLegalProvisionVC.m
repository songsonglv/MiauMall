...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"clauseAgreement"];
...
-(void)LoadYueDing{
    ...
    NSMutableDictionary *param1 = [NSMutableDictionary dictionaryWithDictionary:param];
    if(self.memberToken){
       // @"membertoken":self.memberToken
        [param1 setValue:self.memberToken forKey:@"membertoken"];
    }
