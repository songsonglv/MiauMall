...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"suggestionFeedback"];
...
-(void)LoadTicket{
    ...
    param = [NSMutableDictionary dictionaryWithDictionary:param1];
    if(self.memberToken){
...
-(void)setUI{
    ...
    [lab rz_colorfulConfer:^(RZColorfulConferrer * _Nonnull confer) {
        confer.text([UserDefaultLocationDic valueForKey:@"selectFeed"]).textColor(TCUIColorFromRGB(0x383838)).font([UIFont fontWithName:@"PingFangSC-Medium" size:14]);
    ...
    UILabel *textLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"notSearch"] textColor:TCUIColorFromRGB(0x848484) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
    ...
    UILabel *lab1 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"zi500"] textColor:TCUIColorFromRGB(0xb9b9b9) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
    ...
    UILabel *lab2 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"iemail"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:13 numberOfLines:0];
...
-(void)clickSave{
    ...
    if(self.pids.count == 0){
        [ZTProgressHUD showMessage:[UserDefaultLocationDic valueForKey:@"selectFeed"]];
