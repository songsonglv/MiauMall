...
- (void)viewDidLoad {
    ...
    titleView.titleLa.text = [UserDefaultLocationDic valueForKey:@"receiveAddress"];
    ...
    [btn setTitle:[UserDefaultLocationDic valueForKey:@"addNewAddress"] forState:(UIControlStateNormal)];
...
-(void)setNoneData{
    LYEmptyView *emptyView = [LYEmptyView emptyActionViewWithImageStr:@"zhanweif"
                                                                 titleStr:@""
                                                                detailStr:[UserDefaultLocationDic valueForKey:@"whoAddress"]
                                                              btnTitleStr:@""
                                                            btnClickBlock:^(){
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.clickDeleteBlock = ^(MMAddressModel * _Nonnull model) {
