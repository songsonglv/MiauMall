...
-(void)setUI{
    ...
    if([self.isEnter isEqualToString:@"1"]){
        self.logictisView.y += StatusBarHeight + 46;
        [self.view addSubview:self.logictisView];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if(kind == UICollectionElementKindSectionHeader){
        ...
        UILabel *lab = [UILabel publicLab:[NSString stringWithFormat:@"- %@ -",[UserDefaultLocationDic valueForKey:@"mayLike"]] textColor:TCUIColorFromRGB(0x242424) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:16 numberOfLines:0];
