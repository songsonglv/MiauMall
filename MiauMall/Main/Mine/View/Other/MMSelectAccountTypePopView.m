...
-(void)creatUI{
    ...
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"ialipay"],[UserDefaultLocationDic valueForKey:@"iwechat"],[UserDefaultLocationDic valueForKey:@"bankCard"]];
...
-(void)clickBt:(UIButton *)sender{
    ...
    NSString *type;
    if(sender.tag == 100){
        type = [UserDefaultLocationDic valueForKey:@"ialipay"];
    }else if (sender.tag == 101){
        type = [UserDefaultLocationDic valueForKey:@"iwechat"];
    }else{
        type = [UserDefaultLocationDic valueForKey:@"bankCard"];
    }
