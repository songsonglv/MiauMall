...
-(void)setUI{
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"teamCovertion"],[UserDefaultLocationDic valueForKey:@"teamRepurchase"]];
    NSArray *arr1 = @[[UserDefaultLocationDic valueForKey:@"newUsers"],[UserDefaultLocationDic valueForKey:@"teamOrders"]];
...
-(void)setModel:(MMPartnerDataModel *)model{
    ...
    self.buyNumLa.text = [NSString stringWithFormat:@"%@%@",[UserDefaultLocationDic valueForKey:@"numberUsers"],_model.TeamConversionCount];
    self.repurNumLa.text = [NSString stringWithFormat:@"%@%@",[UserDefaultLocationDic valueForKey:@"repurchaseNum"],_model.TeamRepurchaseCount];
