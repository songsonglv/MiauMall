...
-(void)creatUI{
    ...
    UILabel *nimingLa = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"ianonymous"] textColor:TCUIColorFromRGB(0x848484) textAlignment:(NSTextAlignmentRight) fontWithName:@"PingFangSC-Regular" size:11 numberOfLines:0];
