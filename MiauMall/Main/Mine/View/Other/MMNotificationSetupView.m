...
-(void)creatUI{
    ...
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"emailMessage"],[UserDefaultLocationDic valueForKey:@"systemMessage"],[UserDefaultLocationDic valueForKey:@"logisticsNews"],[UserDefaultLocationDic valueForKey:@"orderMessage"]];
