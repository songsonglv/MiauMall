...
-(void)creatUI{
    UILabel *lab1 = [UILabel publicLab:[UserDefaultLocationDic valueForKey:@"proInfo"] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    lab1.frame = CGRectMake(14, 16, 170, 16);
    ...
    NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"refundReason"],[UserDefaultLocationDic valueForKey:@"refundTime"],[UserDefaultLocationDic valueForKey:@"odrNumber"]];
