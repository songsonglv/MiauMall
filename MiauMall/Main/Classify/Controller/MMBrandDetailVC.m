...
//        [_screenView addSubview:self.screenView];
        NSArray *arr = @[[UserDefaultLocationDic valueForKey:@"xinping"],[UserDefaultLocationDic valueForKey:@"salesVol"],[UserDefaultLocationDic valueForKey:@"iprice"]];
        CGFloat wid = 70;
        CGFloat space = 55;
...
-(void)setUI{
    ...
    self.infoView.tapShareBlock = ^(NSString * _Nonnull str) {
        ...
        dispatch_async(q, ^{
            ...
            object.path = [NSString stringWithFormat:@"pages/shop/brand?id=%@",weakself.model.ID];
            NSData * data = [NSData dataWithContentsOfURL:[NSURL URLWithString:weakself.model.LogoPicture]];
            object.hdImageData = data;
            
            object.withShareTicket = NO;
            object.miniProgramType = WXMiniProgramTypeRelease;
            WXMediaMessage *message = [WXMediaMessage message];
            message.title = weakself.model.Name;
