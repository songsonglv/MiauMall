...
@property (nonatomic, copy) NSString *_totalactivepriceshow;//展示的优惠后总价格 jpy
...
@property (nonatomic, copy) NSString *NoDiscountTips;//品牌直供商品不参与任何优惠
...
@property (nonatomic, copy) NSString *_coupontotalsales; //优惠券优惠
@property (nonatomic, copy) NSString *_coupontotalsalesshow;//优惠券优惠展示
