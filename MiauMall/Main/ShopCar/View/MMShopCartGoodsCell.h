...
@property (nonatomic, copy) void(^tapUpdateBlock)(MMShopCarGoodsModel *model,NSString *num);
@property (nonatomic, copy) void(^tapDeleteBlock)(MMShopCarGoodsModel *model);
@property (nonatomic, copy) void(^tapGoodsBlock)(MMShopCarGoodsModel *model);
