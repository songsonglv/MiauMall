...
-(void)creatUI{
    ...
    NSArray *arr = @[@"1",@"2",@"3"];
    NSArray *nameArr = @[@"提交申请",@"商家处理",@"退款成功"];
    ...
    for (int i = 0; i < arr.count; i++) {
        ...
        UILabel *nameLa = [UILabel publicLab:nameArr[i] textColor:TCUIColorFromRGB(0xa5a5a5) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:13 numberOfLines:0];
        nameLa.frame = CGRectMake(spac + (spac * 2 + 120) * i, 63, 60, 13);
