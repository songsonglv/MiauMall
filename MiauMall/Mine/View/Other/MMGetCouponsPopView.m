...
-(void)creatUI{
    ...
    UILabel *titleLa = [UILabel publicLab:@"领取优惠券" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    ...
    field1.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"请输入提取码获取优惠券" attributes:@{NSForegroundColorAttributeName:TCUIColorFromRGB(0x8a8a8a)}];
    ...
    [shareBt setTitle:@"提取" forState:(UIControlStateNormal)];
