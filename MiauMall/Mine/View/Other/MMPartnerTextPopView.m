...
//    [self.view addGestureRecognizer:tap];
    ...
    UILabel *titleLa = [UILabel publicLab:@"使用指南" textColor:textBlackColor2 textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    ...
    [btn setTitle:@"已阅读并同意" forState:(UIControlStateNormal)];
