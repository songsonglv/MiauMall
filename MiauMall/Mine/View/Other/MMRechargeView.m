...
-(void)setUI{
    ...
    UILabel *integralLa = [UILabel publicLab:[NSString stringWithFormat:@"送%@积分",self.model.less] textColor:TCUIColorFromRGB(0x000000) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Medium" size:10 numberOfLines:0];
