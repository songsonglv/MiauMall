...
-(void)creatUI{
    ...
    UILabel *titleLa = [UILabel publicLab:@"邀请码" textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    titleLa.frame = CGRectMake(0, 30, WIDTH, 15);
    [self.bgView addSubview:titleLa];
    
    UILabel *codeLa = [UILabel publicLab:[NSString stringWithFormat:@"我的邀请码：%@",self.model.memberInfo.RegCode] textColor:TCUIColorFromRGB(0x383838) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    ...
    [shareBt setTitle:@"分享我的邀请码" forState:(UIControlStateNormal)];
