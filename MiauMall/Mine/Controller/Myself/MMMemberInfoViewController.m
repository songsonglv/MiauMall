...
-(void)setUI{
    ...
    UILabel *tipsLa = [UILabel publicLab:@"点击修改头像" textColor:TCUIColorFromRGB(0xa0a0a0) textAlignment:(NSTextAlignmentCenter) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    tipsLa.frame = CGRectMake(0, 164, WIDTH - 20, 15);
    [bgView addSubview:tipsLa];
    
    UILabel *lab1 = [UILabel publicLab:@"用户ID" textColor:TCUIColorFromRGB(0x231815) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    ...
    UILabel *lab2 = [UILabel publicLab:@"昵称" textColor:TCUIColorFromRGB(0x231815) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
...
//    }];
    ...
    UILabel *lab3 = [UILabel publicLab:@"性别" textColor:TCUIColorFromRGB(0x231815) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    lab3.frame = CGRectMake(18, CGRectGetMaxY(tipsLa.frame) + 185, 80, 15);
    [bgView addSubview:lab3];
    
    NSArray *arr = @[@"男",@"女"];
    for (int i = 0; i < arr.count; i++) {
        UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(110 + 88 * i, CGRectGetMaxY(tipsLa.frame) + 184, 38, 15)];
    ...
    UILabel *lab4 = [UILabel publicLab:@"出生日期" textColor:TCUIColorFromRGB(0x231815) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Regular" size:15 numberOfLines:0];
    lab4.frame = CGRectMake(18, CGRectGetMaxY(tipsLa.frame) + 256, 80, 15);
