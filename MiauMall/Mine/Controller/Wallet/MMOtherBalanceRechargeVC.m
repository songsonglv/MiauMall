...
-(void)setUI{
    ...
    UITextField *field = [[UITextField alloc]initWithFrame:CGRectMake(60, StatusBarHeight + 160, WIDTH - 120, 40)];
    field.attributedPlaceholder = [[NSAttributedString alloc]initWithString:@"请输入要充值的金额" attributes:@{NSForegroundColorAttributeName:TCUIColorFromRGB(0xb1b0b0)}];
    field.delegate = self;
...
-(void)clickChong{
    ...
    if(self.moneyField.text.length > 0){
        ...
        [ZTProgressHUD showMessage:@"请输入要充值的金额"];
    }
