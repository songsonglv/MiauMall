...
-(void)setUI{
    ...
    UILabel *lab1 = [UILabel publicLab:@"团队热销商品" textColor:TCUIColorFromRGB(0x231815) textAlignment:(NSTextAlignmentLeft) fontWithName:@"PingFangSC-Medium" size:16 numberOfLines:0];
    lab1.frame = CGRectMake(30, 13, 120, 16);
